...
def calcClimbGradientGeneral(wing_loading, cl_req, cd_0, oswald, c_v, beta, thrust_fraq):
    V = []
    M = []
    theta_t = []
    delta_t = []
...
def calcGradient121c(wing_loading):
    ...
    cd0_adj = ad.c_d0
    osw_adj = ad.oswald
    T_W = calcClimbGradientGeneral(wing_loading, ad.cl_cruise, cd0_adj, osw_adj, c_v, beta, thrust_fraq)
    return T_W
