...
cl_landing = 2.2 
cl_take_off = 1.8
s_wing = 129.8 ###################173.77  # from WP1 matching diagram previously np.mean(ra.df["Wing Surface Area [m²]"]) # [m]
...
cr = 5.918#6.79  # from WP2 iteration ###########################################################################
b = 25.45 # from WP2 iteration ###########################################################################
