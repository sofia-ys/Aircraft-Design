...
for j in range(31):
    L_sec = 0.5*1.225 * 0.3589*(256**2)*func.get_cl(-17.7097+j*0.59, 10)*func.get_chord(-17.7097+j*0.59, 10)
    shear10[j+1]= shear10[j]+ L_sec*0.59

shear_reversed0 = shear0[::-1]
shear_reversed10 = shear10[::-1]
print(shear_reversed0)

plt.plot(xaxis, shear_reversed0, shear_reversed10,marker='o', linestyle='-', color='b')
plt.grid(True)
plt.show()
...
result, error = quad(L_sec, x_start, x_end)
