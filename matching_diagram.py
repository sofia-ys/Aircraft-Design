...
cruise_speed_value = cruise_speed.cruise_thrust_to_weight(wing_loading)
...
take_off_field_length_value = take_off_field_length.take_off_field_length(wing_loading)

climb_rate_value = climb_rate.climb_rate(wing_loading)
...
plt.plot(wing_loading, cruise_speed_value, color = 'indigo', label = 'Cruise speed')
...
plt.plot(wing_loading, take_off_field_length_value, color = 'darkslategray' , label = 'Take off field length')
plt.plot(wing_loading, climb_rate_value, color = 'deeppink', label = 'Climb rate')
plt.plot(landing_field_length, cruise_speed_value[int(np.floor(landing_field_length))], marker = 'D', color = 'crimson', markersize = '6', label = 'Design point')
